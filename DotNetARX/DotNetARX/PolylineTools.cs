...
namespace DotNetARX
{
    ...
    public static class PolylineTools
    {
        ...
        public static void CreatRectangle(this Polyline pline, Point2d pt1, Point2d pt2)
        {
            // 设置矩形的4个顶点
        ...
        public static void CreatePolygon(this Polyline pline, Point2d centerPoint, int number, double radius)
        {
            ...
            {
                Point2d pt = new Point2d(centerPoint.X + radius * Math.Cos(i * angle),
